...
void ADC14_IRQHandler(void)
{
    ...
    conversion_values[0] = ADC14_getResult(ADC_MEM2);
    conversion_values[1] = ADC14_getResult(ADC_MEM3);
    conversion_values[2] = ADC14_getResult(ADC_MEM4);

    handlers[STEP_COUNTER].adc_handler(status, conversion_values);
}
